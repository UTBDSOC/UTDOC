...
```bash
timestamp=$(node "C:/Users/wasif/OneDrive/Desktop/teehee/03 Projects/UTDOC/.claude/get-shit-done/bin/gsd-tools.cjs" current-timestamp full --raw)
```
...
<step name="commit">
```bash
node "C:/Users/wasif/OneDrive/Desktop/teehee/03 Projects/UTDOC/.claude/get-shit-done/bin/gsd-tools.cjs" commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md .planning/HANDOFF.json
```
</step>
